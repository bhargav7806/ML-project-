...
class DataIngestion:
    def __init__(self):
        ...
        ## when call DataIngestion class it stores all data in perticular path 
...
if __name__ == '__main__':
    ...
    train_arr , test_arr , path = data_transformation.initiate_transformation(train_data , test_data)
